...
module.exports = client => {
            ...
            if(prefixRegex.test(message.content)) {
                ...
                if(cmd && cmd.length > 0){
                    if(cmd == "invite" || cmd == "add"){
                        message.reply({
                            embeds: [new Discord.MessageEmbed().setColor("BLURPLE").setTitle(`📨 **VIP Mail**`)
                            .setDescription(`[**Invite VIP Mail**](https://discord.com/api/oauth2/authorize?client_id=898833436171698176&permissions=137439341648&scope=bot)`)
                        ]})
                    } else if(cmd == "setup"){
                        ...
                        if(!client.modmailDb.has(message.guild.id)){
                            return message.reply({
                                embeds: [
                                    new Discord.MessageEmbed()
                                        .setAuthor(serverauthor.tag, serverauthor.displayAvatarURL({dynamic: true}))
                            ...
                            return message.reply({
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setDescription(`This Mail Is Closed Now | You Can Delete This Channel!`)
                                    ]
                            }).catch(console.error)
                        } else {
                            return message.reply({
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("RED")
                                        .setTitle("❌ This Channel is not a Mail!")
                                    ]
                            }).catch(console.error)
                        }
                    }
                            ...
                            return message.reply({
                                    embeds: [
                                        new Discord.MessageEmbed()
                                            ...
                                            .setDescription(`Close the Mail with: \`${config.prefix}forceclose\`\nAfter that, you can delete the Channel!`)
                                        ]
                                }).catch(console.error);
                                ...
                                return message.reply({
                                    embeds: [
                                        new Discord.MessageEmbed()
                                            ...
                                            .setDescription(`Close the Mail with: \`${config.prefix}close\``)
                                        ]
                                }).catch(console.error)
                            })
                            if(!author){
                            ...
                            await author.send({
                                ...
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("GREEN")
                                        .setTitle("✅ Mail Closed By Moderator")
                                    ]
                            }).catch(console.error)
                            await message.author.send({
                                ...
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                                        .setColor("GREEN")
                                        .setTitle("✅ Ticket Closed By Moderator")
                                    ]
                            }).catch(console.error)
                            await message.reply({
                                files: attachment,
                                embeds: [
                                    new Discord.MessageEmbed()
                                        ...
                                        .setColor("GREEN")
                                        .setTitle("✅ Ticket Closed By Moderator")
                                        .setDescription(`This Ticket Is Closed Now | You Can Delete This Channel!`)
                                    ]
                            }).catch(console.error)
    ...
    client.on("ready", () => {
        client.user.setActivity({
            name: "m!help", type: "PLAYING", url: "https://twitch.tv/#"
        })
        ...
        if(interaction.isButton() && interaction.customId == "close_modmail_ticket" && !interaction.guildId){
            ...
            if(!client.modmailDb.has(dmauthor.id))
                return interaction.reply({
                    content: "❌ **You are not having a Mail anymore!**",
                    ephemeral: true
                })
            let guild = client.guilds.cache.get(client.modmailDb.get(dmauthor.id, "id"));
            if(!guild) {
            ...
            await channel.send({
                ...
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setColor("GREEN")
                        .setTitle("✅ User Closed the Mail")
                        .setDescription(`User Closed The Mail. You Can Delete This Channel`)
                    ]
            }).catch(console.error)
            ...
            await author.send({
                ...
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setFooter(`ID: ${serverauthor.id}`, serverauthor.displayAvatarURL({dynamic: true}))
                        .setColor("GREEN")
                        .setTitle("✅ Supporter Closed the Mail")
                    ]
            }).catch(console.error)
            ...
            await interaction.message.reply({
                ...
                embeds: [
                    new Discord.MessageEmbed()
                        ...
                        .setColor("GREEN")
                        .setTitle("✅ Supporter Closed the Mail")
                        .setDescription(`Mail is Close. Delete This Channel Manually!`)
                    ]
            }).catch(console.error)
        ...
        guild.channels.create(`${dmauthor.username}`.substr(0, 32) , {
            ...
            message.reply({
                embeds: [
                    ...
                    .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                    .setColor("BLURPLE")
                    .setTitle("✅ Succesfully Created your Support Mail!")
                    .setDescription(`${data.message}`)
                    .addField("YourMail:", `**${message}**`)
                   ],
                   components: [ new Discord.MessageActionRow().addComponents(new Discord.MessageButton()
                    .setStyle("DANGER").setEmoji("💥").setLabel("Close this Mail").setCustomId("close_modmail_ticket"))]
            }).catch(console.error)
            channel.send({
                embeds: [
                    new Discord.MessageEmbed()
                    ...
                    .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                    .setColor("GREEN")
                    .setTitle("✅ Created an Support Mail!")
                    .addField("Mail: ", `**${message}** `)
                   ],
                   components: [ new Discord.MessageActionRow().addComponents(new Discord.MessageButton()
                    .setStyle("DANGER").setEmoji("💥").setLabel("Close this Mail").setCustomId("close_modmail_ticket"))]
            }).catch(console.error)
            ...
            return message.reply({
                embeds: [
                    ...
                    .setFooter(`ID: ${dmauthor.id}`, dmauthor.displayAvatarURL({dynamic: true}))
                    .setColor("RED")
                    .setTitle("❌ Failed to create the Support Mail! | Cancelled")
                    .setDescription(`\`\`\`${error.message ? String(error.message).substr(0, 2000) : String(e).substr(0, 2000)}\`\`\``)
                   ]
            }).catch(console.error)
        })
